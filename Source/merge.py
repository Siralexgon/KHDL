...
ipynb3 = read_ipynb('Data-Questions-Sang.ipynb')
ipynb4 = read_ipynb('Data-Questions-Đạt.ipynb')
ipynb5 = read_ipynb('Data-Questions-Quang.ipynb')

# Copying the notebook
ipynb_final = copy.deepcopy(ipynb1)

# Concatenating the notebooks
ipynb_final['cells'] = ipynb1['cells'] + ipynb2['cells'] + ipynb3['cells'] + ipynb4['cells'] + ipynb5['cells']
